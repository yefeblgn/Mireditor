...
export function ShortcutsModal({ onClose }: { onClose: () => void }) {
  const shortcuts = [
    ...
    { category: 'Düzenleme', items: [
      ...
      { key: 'Ctrl+Alt+Z', desc: 'Adım Adım Geri Al' },
      { key: 'Ctrl+Shift+Z / Ctrl+Y', desc: 'Yinele' },
      { key: 'Ctrl+C', desc: 'Kopyala' },
      { key: 'Ctrl+X', desc: 'Kes' },
      { key: 'Ctrl+V', desc: 'Yapıştır' },
      { key: 'Ctrl+T', desc: 'Serbest Dönüştür' },
      { key: 'Ctrl+I', desc: 'Renkleri Ters Çevir' },
      { key: 'Delete', desc: 'Seçili Alanı Sil' },
      { key: 'Alt+Del', desc: 'Ön Plan Rengiyle Doldur' },
      { key: 'Ctrl+Del', desc: 'Arka Plan Rengiyle Doldur' },
    ]},
    { category: 'Seçim', items: [
      { key: 'Ctrl+A', desc: 'Tümünü Seç' },
      { key: 'Ctrl+D', desc: 'Seçimi Kaldır' },
      { key: 'Ctrl+Shift+I', desc: 'Seçimi Tersine Çevir' },
    ]},
    { category: 'Katman', items: [
      { key: 'Ctrl+Shift+N', desc: 'Yeni Katman' },
      { key: 'Ctrl+J', desc: 'Katmanı Çoğalt' },
      { key: 'Ctrl+E', desc: 'Aşağıyla Birleştir' },
      { key: 'Ctrl+Shift+E', desc: 'Tüm Katmanları Birleştir' },
      { key: 'Ctrl+]', desc: 'Katmanı Yukarı Taşı' },
      { key: 'Ctrl+[', desc: 'Katmanı Aşağı Taşı' },
    ]},
    { category: 'Araçlar', items: [
      { key: 'V', desc: 'Taşı' },
      { key: 'M', desc: 'Dikdörtgen Seçim' },
      { key: 'L', desc: 'Kement' },
      { key: 'C', desc: 'Kırpma' },
      { key: 'I', desc: 'Damlalık' },
      { key: 'B', desc: 'Fırça' },
      { key: 'N', desc: 'Kalem' },
      { key: 'E', desc: 'Silgi' },
      { key: 'G', desc: 'Dolgu (Kova)' },
      { key: 'R', desc: 'Gradyan' },
      { key: 'S', desc: 'Klon Damgası' },
      { key: 'T', desc: 'Metin' },
      { key: 'U', desc: 'Şekil' },
      { key: 'H', desc: 'El' },
      { key: 'Z', desc: 'Yakınlaştır' },
      { key: 'Space (basılı)', desc: 'Geçici El Aracı' },
    ]},
    { category: 'Görünüm', items: [
      { key: 'Ctrl++', desc: 'Yakınlaştır' },
      { key: 'Ctrl+-', desc: 'Uzaklaştır' },
      { key: 'Ctrl+0', desc: 'Ekrana Sığdır' },
      { key: 'Ctrl+1', desc: 'Gerçek Boyut (%100)' },
      { key: 'F5', desc: 'Renk Panelini Aç' },
      { key: 'F7', desc: 'Katmanlar Panelini Aç' },
      { key: 'F1', desc: 'Kısayollar Yardım' },
    ]},
    { category: 'Fırça ve Renk', items: [
